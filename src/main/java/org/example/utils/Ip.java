...
public class Ip {
    ...
    //PROXY
    public static final String PROXY_PRINCIPAL = "localhost";
    public static final String PROXY_SECUNDARIO = "10.43.100.223";

    //HEALTH CHECKER
    public static final String HEALTH_CHECKER = "10.43.100.223";

    //SISTEMAS DE CALIDAD
    public static final String SC_FOG = "localhost";
    public static final String SC_EDGE = "localhost";
    public static final String SC_CLOUD = "localhost";
